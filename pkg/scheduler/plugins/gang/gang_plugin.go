...
// GlobalGangPlugin : global unique GangPlugin
//Since QueueSortPlugin has to read the gang info
//So we set this variable to be used by the other Plugin
var GlobalGangPlugin *GangPlugin
...
func New(args runtime.Object, handle framework.Handle) (framework.Plugin, error) {
	//
	if GlobalGangPlugin != nil {
		return GlobalGangPlugin, nil
	}
...
func (p *GangPlugin) GetCreatTime(podInfo *framework.QueuedPodInfo) time.Time {
	gangName := podInfo.Pod.Annotations[GangNameAnnotation]
	if gangName == "" {
